...
app.controller('MDDialogCtrl', function($scope, $mdDialog) {
  ...
  $scope.showAdvanced = function(ev) {
    $mdDialog.show({
      ...
      templateUrl: '/app/views/ui/material/dialog.tmpl.html',
      targetEvent: ev,
    })
...
app.controller('MDSubheaderCtrl', function($scope) {
    $scope.messages = [
      {
        face : 'assets/assets/images/a0.jpg',
      ...
      {
        face : 'assets/assets/images/a1.jpg',
        what: 'Brunch this weekend?',
        who: 'Min Li Chan',
        when: '3:08PM',
        notes: " I'll be in your neighborhood doing errands"
      ...
      {
        face : 'assets/assets/images/a2.jpg',
        what: 'Brunch this weekend?',
        who: 'Min Li Chan',
        when: '3:08PM',
        notes: " I'll be in your neighborhood doing errands"
      ...
      {
        face : 'assets/assets/images/a3.jpg',
        what: 'Brunch this weekend?',
        who: 'Min Li Chan',
        when: '3:08PM',
        notes: " I'll be in your neighborhood doing errands"
      ...
      {
        face : 'assets/assets/images/a4.jpg',
        what: 'Brunch this weekend?',
        who: 'Min Li Chan',
        when: '3:08PM',
        notes: " I'll be in your neighborhood doing errands"
      ...
      {
        face : 'assets/assets/images/a5.jpg',
        what: 'Brunch this weekend?',
        who: 'Min Li Chan',
        when: '3:08PM',
        notes: " I'll be in your neighborhood doing errands"
      ...
      {
        face : 'assets/assets/images/a6.jpg',
        what: 'Brunch this weekend?',
        who: 'Min Li Chan',
        when: '3:08PM',
        notes: " I'll be in your neighborhood doing errands"
      ...
      {
        face : 'assets/assets/images/a7.jpg',
        what: 'Brunch this weekend?',
        who: 'Min Li Chan',
        when: '3:08PM',
        notes: " I'll be in your neighborhood doing errands"
      ...
      {
        face : 'assets/assets/images/a8.jpg',
        what: 'Brunch this weekend?',
        who: 'Min Li Chan',
        when: '3:08PM',
        notes: " I'll be in your neighborhood doing errands"
      ...
      {
        face : 'assets/assets/images/a9.jpg',
        what: 'Brunch this weekend?',
        who: 'Min Li Chan',
        when: '3:08PM',
        notes: " I'll be in your neighborhood doing errands"
...
app.controller('MDToastCtrl', function($scope, $mdToast, $animate) {
  ...
  $scope.showCustomToast = function() {
    $mdToast.show({
      ...
      templateUrl: '/app/views/ui/material/toast.tmpl.html',
      hideDelay: 6000,
      parent:'#toast',
